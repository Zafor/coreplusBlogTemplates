<div class="cta-section">
    <div class="cta-section-content blog-width  row flex-column-reverse flex-lg-row flex-md-row">
        ...
        <div class="cta-button col-md-6 col-md-pull-6 margin-top-40">
            ...
            <input type="text" name="blog-subscriber-email" id="subscriptionInput" class="btn blog-subscriber-email no-wrap" required placeholder="Enter your Email Address" style="text-transform:none;text-align:left">
...
// 						console.log(response);
						...
						document.getElementById("subscriptionButton").src="https://qa-web.coreplus.com.au/wp-content/uploads/2021/08/subscription-success.png";
