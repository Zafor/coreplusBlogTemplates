...
/*
* Template Name: Blog Category-Product Releases
*/
    ...
    <div class="blog-width">
        <div class="keypoint-header-content row">
            <div class="keypoint-header-image  col-md-6 col-md-push-6">
                <img src="<?php echo get_field('blog_key_point_five_image') ?>" alt="">
            </div>
            <div class="keypoint-header-content-details col-md-6 col-md-pull-6">
                <h3 class="keypoint-header-title"><?php echo get_field('blog_key_point_five_title'); ?></h3>
